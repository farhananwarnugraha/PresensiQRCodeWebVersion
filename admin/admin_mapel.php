<?php
  ...
  $mapel = query ("SELECT matapelajaran.`id_mapel`,matapelajaran.`nama_mapel`,matapelajaran.guru_mapel, guru.`id_guru`, guru.`nama_guru`, matapelajaran.`kategori_mapel`, jurusan.`id_jurusan`, jurusan.`nama_jurusan`
                    FROM matapelajaran 
...
<html lang="en">
  ...
  <body>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">Daftar Matapelajaran</div>
        </div>
              ...
              <div class="modal-body">
                ...
                <form action= "" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" aria-describedby="namamapel" placeholder="Nama Matapelajaran">
                  </div>
                  <div class="mb-3">
                    <label for="kurikulum" class="form-label">Pengampu Matapelajaran</label>
                    <select id="kurikulum" name="nama_guru" class="form-select" aria-label="Default select example">
                  ...
                  <div class="mb-3">
                    <label for="kurikulum" class="form-label">Kategori</label>
        ...
        <table class="table text-center">
          <tr>
            <th scope="col">No</th>
            <th scope="col">Nama Matapelajaran</th>
          ...
          ?>
            <tr>
              ...
              <td><?= $row['nama_guru']?></td>
              <td>
                <a href="edit_mapel.php?id_mapel=<?= $row['id_mapel']?>" type="button" class="btn btn-warning btn-sm" >
                  <i class="bi bi-pencil-square"></i>
                    Ubah
                </a>
                <a href="hapus_mapel.php?id_mapel=<?= $row['id_mapel']?>" type="button"  onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" class="btn btn-danger btn-sm">
