      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">
            ...
            Ubah Presensi Matapelajaran
          </div>
        </div>
          <form action="log/ubahpresmapel.php" method="POST">
            <div class="mb-1">
               <input type="text" class="form-control" id="kode_kelas" name="id_presensi" hidden aria-describedby="kode_kelas" readonly value="<?= $dataabsen['id_presensi']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">NIS Siswa</label>
              <input type="text" class="form-control" id="nama_kelas" name="nis_siswa" aria-describedby="nama_kelas" readonly value="<?= $dataabsen['nis_siswa']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Nama Siswa</label>
              <input type="text" class="form-control" id="nama_kelas" name="nama_siswa" aria-describedby="nama_kelas" readonly value="<?= $dataabsen['nama_siswa']?>">
            </div>
            <div class="mb-1">
              <input type="text" class="form-control" id="nama_kelas" name="siswa" aria-describedby="nama_kelas" hidden readonly value="<?= $dataabsen['siswa']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Waktu Presensi</label>
              <input type="text" class="form-control" id="nama_kelas" name="waktu_presensi" aria-describedby="nama_kelas" readonly value="<?= $dataabsen['waktu_presensi']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Tanggal</label>
              <input type="text" class="form-control" id="nama_kelas" name="pertemuan" aria-describedby="nama_kelas" readonly value="<?= $dataabsen['tanggal_presensi']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Jam</label>
              <input type="text" class="form-control" id="nama_kelas" name="pertemuan" aria-describedby="nama_kelas" readonly value="<?= $dataabsen['waktu_presensi']?>">
            </div>
            <div class="mb-1">
              <input type="text" class="form-control" id="nama_kelas" name="pertemuan" aria-describedby="nama_kelas" readonly hidden value="<?= $dataabsen['nama_mapel']?>">
            </div>
            <div class="mb-1">
              <label for="guru_kelas" class="form-label fw-bold">Keterangan</label>
              <select id="guru_kelas" name="keterangan" class="form-select" aria-label="Default select example">
                <option selected value="<?= $dataabsen['keterangan']?>"><?= $dataabsen['keterangan']?></option>
