<?php
  ...
  $data_kelas = query("SELECT * FROM pengumuman WHERE id_pengumuman = '$id'")[0];
?> 
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          ...
          <form action="../log/pengumuman.php" method="POST">
            <div class="mb-1">
               <input type="text" class="form-control" id="kode_kelas" name="id_pengumuman" hidden aria-describedby="kode_kelas" readonly value="<?= $data_kelas['id_pengumuman']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Tanggal Pnegumuan</label>
              <input type="text" class="form-control" id="nama_kelas" readonly name="tgl" aria-describedby="nama_kelas" value="<?= $data_kelas['tgl_pengumuman']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Isi Pengumuman</label>
              <input type="text" class="form-control" id="nama_kelas"  name="isi" aria-describedby="nama_kelas" value="<?= $data_kelas['isi_pengumuman']?>">
            </div>
