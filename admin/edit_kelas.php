<?php
  ...
  $data_kelas = query("SELECT kelas.id_kelas, kelas.nama_kelas, kelas.jurusan, jurusan.id_jurusan, jurusan.nama_jurusan FROM `kelas` JOIN jurusan ON jurusan.id_jurusan = kelas.jurusan WHERE id_kelas = '$kod_kelas'")[0];
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <form action="log_edit_kelas.php" method="POST">
            <div class="mb-1">
               <input type="text" class="form-control" id="kode_kelas" name="kode_kelas" hidden aria-describedby="kode_kelas" readonly value="<?= $data_kelas['id_kelas']?>">
            </div>
            <div class="mb-1">
            ...
            <div class="mb-1">
              <label for="guru_kelas" class="form-label fw-bold">Jurusan</label>
              <select id="guru_kelas" name="jurusan" class="form-select" aria-label="Default select example">
                <option selected value="<?= $data_kelas['jurusan']?>"><?= $data_kelas['nama_jurusan']?></option>
                <?php
