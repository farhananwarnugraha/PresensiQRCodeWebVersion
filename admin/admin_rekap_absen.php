<?php
  ...
  // $absen = query("SELECT absen_siamad.`nis_siswa`, siamad_siswa.`nama_siswa`, siamad_kelas.`kode_kelas`,absen_siamad.`keterangan`
  ...
  $tanggal = query("SELECT waktu_presensi FROM presensi_masuk");
  $mapel = query("SELECT nama_mapel FROM matapelajaran");
  $pertemuan = query("SELECT waktu_presensi FROM presensi_mapel");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="offcanvas-body p-0">
        <nav class="navbar-dark">
          <ul class="navbar-nav">
            ...
            <li>
              <a class="nav-link px-3 sidebar-link active" data-bs-toggle="collapse" href="#report" role="button" aria-expanded="false" aria-controls="collapseExample">
                <span class="me-2">
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="col md-12 fw-bold fs-3 mb-2">
            ...
            Rekap Presensi Siswa Masuk
          </div>
        <form action="../laporan/cetak.php" method="POST">
          <div class="mb-3">
            <select id="semester" name="kelas" class="form-select" aria-label="Default select example">
          ...
          <div class="mb-3">
          <input type="date" name="tgl" class="form-control" id="batas_tanggal">
          Sampai
          <input type="date" name="tgl_akhir" class="form-control" id="batas_tanggal">
          </div>
          
          <button type="submit" name="tampil" class="btn btn-outline-success" target="blank">
        ...
        <div class="shadow p-3 mb-5 bg-body rounded">
          <div class="col md-12 fw-bold fs-3 mb-2">
            <i class="bi bi-file-earmark-spreadsheet"></i>
            Rekap Presensi Matapelajaran
          </div>
        <form action="../laporan/rekappresmapel.php" method="POST">
          <div class="mb-3">
            <select id="semester" name="mapel" class="form-select" aria-label="Default select example">
