<?php
  ...
  // $mapel = query ("SELECT matapelajaran.id_mapel,matapelajaran.nama_mapel,matapelajaran.guru_mapel,matapelajaran.kategori_mapel,guru.id_guru,guru.nama_guru,kategori_mapel.id_kategori,kategori_mapel.nama_kategori FROM matapelajaran JOIN guru ON guru.id_guru = matapelajaran.guru_mapel JOIN kategori_mapel ON kategori_mapel.id_kategori = matapelajaran.kategori_mapel");
...
<html lang="en">
  ...
  <body>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3 text-center">Buat QR Presensi</div>
        </div>
        ...
        <!-- Modal -->
        <form method="POST" action=" " class="row g-3 mt-2 pt-3 shadow p-3 mb-5 bg-body rounded">
          <div class="col-12">
            <label for="batas_tanggal" class="form-label">Batas Tanggal</label>
            <input type="date" name="batas_tanggal" class="form-control" id="batas_tanggal" placeholder="1234 Main St">
          </div>
          <div class="col-12">
            <label for="batas_waktu" class="form-label">Batas Waktu</label>
            <input type="time" name="batas_waktu" class="form-control" id="batas_waktu" placeholder="1234 Main St">
          </div>
          <div class="col-12 text-center">
            <button type="submit" name="buat" class="btn btn-success ">Buat QR Code</button>
          </div>
        </form>
        <!-- QR Code -->
        <div class="hasil text-center mt-2">
            <?php 
            if(isset($_POST['buat'])){
              ...
              $insert = "INSERT INTO jadwal_masuk VALUES ('$id_jadwal','$batas_waktu','$batas_tanggal')";
