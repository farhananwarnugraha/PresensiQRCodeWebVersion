...
//   SELECT orangtua.id_orangtua,orangtua.nama_orangtua,orangtua.siswa_orangtua,siswa.id_siswa, siswa.nama_siswa FROM orangtua
// JOIN siswa ON siswa.id_siswa = orangtua.siswa_orangtua
  $ortu = query("SELECT orangtua.id_orangtua,orangtua.nama_orangtua,orangtua.siswa_orangtua,orangtua.no_tlp,orangtua.alamat_ortu,siswa.id_siswa, siswa.nama_siswa FROM orangtua
  JOIN siswa ON siswa.id_siswa = orangtua.siswa_orangtua");
...
<html lang="en">
  ...
  <body>
              ...
              <div class="collapse" id="datamaster">
                <div>
                  ...
                  <li>
                    ...
                    <li>
                      <a href="admin_ortu.php" class="nav-link px-4 active"> Data Orang Tua Siswa </a>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <main class="mt-5 pt-3 shadow-sm p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">Daftar Orang Tua Siswa</div>
        </div>
          ...
          <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- Form tambah data -->
                <?php
                  // $query = mysqli_query($conect, "SELECT MAX(id_ortu) AS idterbesar FROM ortu_siamad");
                  // $data = mysqli_fetch_array($query);
                  // $idortu = $data['idterbesar'];
                  // $urutan = (int) substr($idortu, 3, 3);
                  // $urutan++;
                  // $huruf = 'ORTU';
                  // $idortu = $huruf . sprintf("%03s", $urutan);
                ...
                <form action=" " method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_ortu" name="nama_orangtua" aria-describedby="namaortu" placeholder="Nama Orang Tua">
                  </div>
                  <div class="mb-3">
                    <label for="alamat_ortu" class="form-label">Alamat Lengkap</label>
                    <textarea type="text" class="form-control" id="alamat_ortu" name="alamat_ortu" aria-describedby="alamat" placeholder="Alamat lengkap"></textarea>
                  </div>
                  <div class="mb-3">
                    <label for="tlp_ortu" class="form-label">ID Telegram</label>
                    <input type="text" class="form-control" id="telp_ortu" name="telp_ortu" aria-describedby="telepon" placeholder="Cek melalui Telegram, Ex: 6797991278">
                  </div>
                  <div class="mb-3">
                    <label for="nis_siswa" class="form-label">Nama Siswa</label>
                    <select id="nis_siswa" name="siswa_orangtua" class="form-select" aria-label="Default select example">
        ...
        <!-- Btn Tambah Data with Modal -->
        <!-- Tabel Guru -->
        <table class="table text-center align-middle border mt-2">
          <thead class="text-center align-middle">
            <th scope="col">No</th>
            <th scope="col">Nama Orangtua Siswa</th>
          ...
          <tr>
            <tr>
              ...
              <td class="text-center">
                <a href="edit_ortu.php?ortu=<?= $row['id_orangtua']?>" type="button" class="btn btn-warning btn-sm mb-1">
                    <i class="bi bi-pencil-square"></i>
                      Ubah
                </a>
                <a href="hapus_ortu.php?ortu=<?= $row['id_orangtua']?>"  onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" type="button" class="btn btn-danger btn-sm">
