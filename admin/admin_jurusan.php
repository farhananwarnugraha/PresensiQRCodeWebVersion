<?php
  ...
  $jurusan = query("SELECT * FROM jurusan WHERE nama_jurusan <> 'Umum' ");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
              ...
              <div class="collapse" id="akademik">
                <div>
                  <ul class="navbar-nav ps-3">
                    ...
                    <li>
                      <a href="admin_jurusan.php" class="nav-link px-4 active"> Jurusan </a>
                    </li>
                    <li>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">Daftar Jurusan</div>
        </div>
              ...
              <div class="modal-body">
                ...
                <form action=" " method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" aria-describedby="namakelas" placeholder="Nama Kelas">
                  </div>
        ...
        <table class="table table-striped table-hover border rounded mt-2 text-center">
          ...
          ?>
            <tr>
              ...
              <td>
                  <a href="edit_jurusan.php?kode_jurusan=<?= $row['id_jurusan']?>" type="button" class="btn btn-warning btn-sm">
                    <i class="bi bi-pencil-square"></i>
                    Ubah
                  </a>
                  <a href="hapus_jurusan.php?kode_jurusan=<?= $row['id_jurusan']?>"  onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" type="button" class="btn btn-danger btn-sm">
