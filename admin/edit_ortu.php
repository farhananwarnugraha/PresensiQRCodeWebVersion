<?php
  ...
  $data_ortu = query("SELECT orangtua.id_orangtua,orangtua.nama_orangtua,orangtua.siswa_orangtua,orangtua.no_tlp,orangtua.alamat_ortu,siswa.id_siswa, siswa.nama_siswa FROM orangtua
  JOIN siswa ON siswa.id_siswa = orangtua.siswa_orangtua WHERE id_orangtua = '$ortu'")[0];
  // $data_ortu = query("SELECT * FROM orangtua WHERE id_orangtua = '$ortu'")[0];
        ...
        <div class="row">
          ...
          <i class="bi bi-pencil-square"></i>
            Edit Data Orang Tua Siswa
                ...
                <form action="log_edit_ortu.php" method="POST" class="shadow p-3 mb-5 bg-body rounded">
                  <div class="mb-2">
                    <input type="text" class="form-control" id="kd_ortu" name="kd_ortu" aria-describedby="namaortu" hidden value="<?= $data_ortu['id_orangtua']?>">
                  </div>
                  <div class="mb-2">
                    <label for="nama_ortu" class="form-label fw-bold">Nama Lengkap</label>
                    <input type="text" class="form-control" id="nama_ortu" name="nama_ortu" aria-describedby="namaortu" value="<?= $data_ortu['nama_orangtua']?>">
                  </div>
                  <div class="mb-2">
                    <label for="alamat_ortu" class="form-label fw-bold">Alamat Lengkap</label>
                    <input type="text" class="form-control" id="alamat_ortu" name="alamat_ortu" aria-describedby="alamat" value="<?= $data_ortu['alamat_ortu']?>">
                  </div>
                  <div class="mb-2">
                    <label for="nis_siswa" class="form-label fw-bold">Nama Siswa</label>
                    <select id="nis_siswa" name="nis_siswa" class="form-select" aria-label="Default select example">
                    <option selected value="<?= $data_ortu['siswa_orangtua']?>"><?= $data_ortu['nama_siswa']?></option>
                    <?php
                  ...
                  <div class="mb-2">
                    <label for="tlp_ortu" class="form-label fw-bold">No.Telepon</label>
                    <input type="text" class="form-control" id="telp_ortu" name="telp_ortu" aria-describedby="telepon" value="<?= $data_ortu['no_tlp']?>">
                  </div>
