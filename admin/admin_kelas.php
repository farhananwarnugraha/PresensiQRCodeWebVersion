<?php
  ...
  $kelas = query ("SELECT kelas.id_kelas, kelas.nama_kelas, kelas.jurusan, jurusan.id_jurusan, jurusan.nama_jurusan FROM `kelas` JOIN jurusan ON jurusan.id_jurusan = kelas.jurusan");
...
<html lang="en">
  ...
  <body>
            ...
            <li>
              ...
              <div class="collapse" id="akademik">
                <div>
                  <ul class="navbar-nav ps-3">
                  <li>
                      <a href="admin_kelas.php" class="nav-link px-4 active"> Kelas </a>
                    </li>
                    <li>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">Daftar Kelas</div>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form action=" " method="POST">
                  ...
                  <div class="mb-3">
                    <label for="nik_guru" class="form-label">Jurusan</label>
                    <select id="nik_guru" name="jurusan" class="form-select" name="walikelas" aria-label="Default select example">
        ...
        <table class="table table-striped table-hover border rounded mt-2 text-center">
          ...
          ?>
            <tr>
              ...
              <td>
                  <a href="edit_kelas.php?kode_kelas=<?= $row['id_kelas']?>" type="button" class="btn btn-warning btn-sm">
                    <i class="bi bi-pencil-square"></i>
                    Ubah
                  </a>
                  <a href="hapus_kelas.php?kode_kelas=<?= $row['id_kelas']?>"  onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" type="button" class="btn btn-danger btn-sm">
