<?php
  ...
  $kelas = query ("SELECT * FROM pengumuman ORDER BY tgl_pengumuman DESC");
...
<html lang="en">
  ...
  <body>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          <div class="col md-12 fw-bold fs-3">Pengumuman</div>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form action=" " method="POST">
                  <div class="mb-3">
                    <label for="nama_kelas" class="form-label">Tanggal</label>
                    <input type="date" class="form-control" id="nama_kelas" name="tgl" aria-describedby="namakelas" placeholder="Nama Kelas">
                  </div>
                  
                  <div class="mb-3">
                    <label for="nama_kelas" class="form-label">Nama Kelas</label>
                    <textarea type="text" class="form-control" id="nama_kelas" name="isi_pengumuman" aria-describedby="namakelas" placeholder="Isi Pengumuman"></textarea>
                  </div>
        ...
        <!-- Btn Tambah Data with Modal -->
        <!-- Tabel Guru -->
        <table class="table table-striped table-hover border rounded mt-2 text-center">
          ...
          ?>
            <tr>
              ...
              <td>
                  <a href="edit/pengumuman.php?id=<?= $row['id_pengumuman']?>" type="button" class="btn btn-warning btn-sm">
                    <i class="bi bi-pencil-square"></i>
                    Ubah
                  </a>
                  <a href="log/hapuspengumuman.php?id=<?= $row['id_pengumuman']?>"  onclick="return confirm('Apakah Anda ingin menghapus data ini ?')" type="button" class="btn btn-danger btn-sm">
