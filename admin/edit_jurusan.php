<?php
  ...
  $data_jurusan = query("SELECT * FROM `jurusan` WHERE id_jurusan = '$kode_jurusan'")[0];
?> 
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          ...
          <form action="log_edit_jurusan.php" method="POST">
            <div class="mb-1">
               <input type="text" class="form-control" id="kode_kelas" name="kode_kelas" hidden aria-describedby="kode_kelas" readonly value="<?= $data_jurusan['id_jurusan']?>">
            </div>
            <div class="mb-1">
              <label for="nama_jurusan" class="form-label fw-bold fs-6">Nama Jurusan</label>
              <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" aria-describedby="nama_jurusan" value="<?= $data_jurusan['nama_jurusan']?>">
            </div>
