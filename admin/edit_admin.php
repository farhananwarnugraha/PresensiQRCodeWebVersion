<?php
  ...
  $data_admin = query("SELECT * FROM admin WHERE id_admin = '$id_admin'")[0];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <li>
              ...
              <div class="collapse" id="report">
                <div>
                  <ul class="navbar-nav ps-3">
                    <li>
                      <a href="admin_absen.php" class="nav-link px-4"> Presensi Siswa </a>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        <div class="row">
          ...
          <form action="log_edit_admin.php" method="POST" class="shadow p-3 mb-5 bg-body rounded">
            <div class="mb-1">
               <label for="nip" class="form-label mb-1 mt-1 fw-bold fs-6">Id Admin</label>
               <input type="text" class="form-control" id="nip" name="id_admin" aria-describedby="nipguru" readonly value="<?= $data_admin['id_admin']?>">
            </div>
            <div class="mb-1">
              <label for="nama_guru" class="form-label fw-bold fs-6">Username</label>
              <input type="text" class="form-control" id="nama_guru" name="username_admin" aria-describedby="namaguru" value="<?= $data_admin['usename_admin']?>" >
            </div>
            <div class="mb-1">
            ...
            <div class="mb-1">
              ...
              <input type="password" class="form-control" id="exampleInputPassword1" name="pwd_admin" value="<?= $data_admin['pass_admin']?>">
            </div>
