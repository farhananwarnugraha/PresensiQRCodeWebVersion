<?php
  ...
  $dataabsen = query("SELECT presensi_masuk.id_presensi, presensi_masuk.siswa,presensi_masuk.tanggal_presensi,presensi_masuk.waktu_presensi,presensi_masuk.keterangan,siswa.id_siswa,siswa.nis_siswa,siswa.nama_siswa,siswa.kelas_siswa,siswa.jurusan_siswa,kelas.id_kelas,kelas.nama_kelas,jurusan.id_jurusan,jurusan.nama_jurusan FROM `presensi_masuk` JOIN siswa ON siswa.id_siswa = presensi_masuk.siswa JOIN kelas ON siswa.kelas_siswa = kelas.id_kelas JOIN jurusan ON siswa.jurusan_siswa = jurusan.id_jurusan WHERE id_presensi = '$kode'")[0];
    ...
    <main class="mt-5 pt-3 shadow p-3 mb-5 bg-body rounded">
      <div class="container-fluid">
        <div class="row">
          ...
          <form action="log/editpresMasuk.php" method="POST">
            <div class="mb-1">
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control" id="nama_kelas" name="nis_siswa" readonly aria-describedby="nama_kelas" value="<?= $dataabsen['nis_siswa']?>">
            </div>
            <div class="mb-1">
            ...
            <div class="mb-1">
              <input type="text" class="form-control" id="nama_kelas" name="siswa" readonly aria-describedby="nama_kelas" hidden value="<?= $dataabsen['siswa']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Jam Presensi</label>
              <input type="time" class="form-control" id="nama_kelas" name="Jam_presensi" readonly aria-describedby="nama_kelas" value="<?= $dataabsen['waktu_presensi']?>">
            </div>
            <div class="mb-1">
              <label for="nama_kelas" class="form-label fw-bold fs-6">Tanggal Presensi</label>
              <input type="date" class="form-control" id="nama_kelas" name="waktu_presensi" readonly aria-describedby="nama_kelas" value="<?= $dataabsen['tanggal_presensi']?>">
            </div>
            <div class="mb-1">
